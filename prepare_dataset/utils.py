...
#
# Args
#   - pred_all (torch float): dot product of graph
#   - pos_edges (numpy array): tuples of (source, target) connected nodes
#   - neg_edges (numpy array): tuples of (source, target) disconnected nodes
#
# Return
